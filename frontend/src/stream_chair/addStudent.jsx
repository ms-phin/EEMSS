...
export default function DeptRegistrationForm() {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      formData.append('confrimepassword', values.confrimepassword);
      ...
      axios.post('http://localhost:5000/api/registerStudent', formData, {
        ...
        <Form>
          <div className="form">
            <div className="form-body">
              <div className="header">
                <p>
                  Welcome, please <b className="head">Add Student</b>
                </p>
              </div>
              <br />
              <div className="enter">
